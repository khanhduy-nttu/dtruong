...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi bé!";
    let charArrTitle = textTitle.split('');
let text = "Chúc bé Linh đáng yêu, cô sinh viên năm cuối xinh xắn, một mùa Giáng Sinh thật rực rỡ và ý nghĩa! 🎄✨ Mong bé luôn tràn đầy năng lượng, vượt qua mọi thử thách để hoàn thành thật xuất sắc năm cuối đại học. Chúc bé nhận được thật nhiều niềm vui, quà xinh và những lời yêu thương từ mọi người. Hãy tận hưởng từng khoảnh khắc đẹp đẽ và luôn tự tin vào bản thân nhé! I❤️U🎅❄️"
